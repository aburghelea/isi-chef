...
<section id="nota-table">
    <table class="table">
        ...
        <tr class="prop" cellpaddinng="0" cellspacing="0">
            <td valign="top" style="text-align: left;" class="value"><g:message code="nota.total.plata.label" default="TOTAL DE PLATA: ${'<br>'} din care TVA:"/></td>
            <td valign="top" style="text-align: left;" class="value"> </td>
            <td valign="top" style="text-align: left;" class="value"> </td>
            <td valign="top" style="text-align: left;" class="value">  ${costTotal} <br><br> ${costTotal*16/100} </td>
    ...
    <p align="center"><g:message code="nota.thanks.message" default="TIPS NOT INCLUDED ${'<br>'} VA MULTUMIM ${'<br>'} THANK YOU ${'<br>'} REZERVARI LA TELEFON: 0743.061.489" /></p>
</section>
