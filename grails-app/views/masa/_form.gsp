...
<div class="control-group fieldcontain ${hasErrors(bean: masaInstance, field: 'description', 'error')} ">
    <label for="description" class="control-label"><g:message code="masa.description.label"
        ...
        <ul class="one-to-many">
            ...
            <li class="add">
                <g:link controller="comanda" action="create"
                        params="['masa.id': masaInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'comanda.label', default: 'Comanda')], default: 'Add ' + message(code: 'comanda.label', default: 'Comanda'))}</g:link>
            </li>
        </ul>
        ...
        <ul class="one-to-many">
            ...
            <li class="add">
                <g:link controller="rezervare" action="create"
                        params="['masa.id': masaInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'rezervare.label', default: 'Rezervare')], default: 'Add ' + message(code: 'rezervare.label', default: 'Rezervare'))}</g:link>
            </li>
        </ul>
