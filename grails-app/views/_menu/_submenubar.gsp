...
<g:if test="${params.controller != null && params.controller != '' && params.controller != 'home'&& params.controller != 'default' && params.action != 'emailClients' && params.controller != 'login'}">
