<ul class="nav pull-right">
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li class="controller">
                <a tabindex="-1" href="#"><b><g:message code="default.visual.style.label" default="Visual Style"/></b>
                </a>
            </li>
            <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <li><a class="" title="${message(code: 'default.config.vertical.label', default: 'Vertical')}"
                           href="${request.forwardURI + '?layout=grid'}">
                        <i class="icon-resize-vertical"></i>
                        <g:message code="default.layout.grid.label" default="Grid 940px (Menu Top)"/>
                    </a></li>
                    <li><a class="" title="${message(code: 'default.config.horizontal.label', default: 'Horizontal')}"
                           href="${request.forwardURI + '?layout=fluid'}">
