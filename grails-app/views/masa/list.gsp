	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<g:sortableColumn property="description" title="${message(code: 'masa.description.label', default: 'Description')}" />
		...
		<g:each in="${masaInstanceList}" status="i" var="masaInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td><g:link action="show" id="${masaInstance.id}">${fieldValue(bean: masaInstance, field: "number")}</g:link></td>
