	...
	<div class="container">
		<div class="row">
			...
			<div class="span8">
				...
				<p><g:message code="default.footer.information" default="Designed and built with Twitter's ${'<a href="http://twitter.github.com/bootstrap/" target="_blank">Bootstrap</a>'}.
				...
				<p><g:message code="default.footer.incons.information" default="Icons from ${'<a href="http://glyphicons.com">Glyphicons Free</a>'}, licensed under ${'<a href="http://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>'}."/></p>
			</div>
		</div>
