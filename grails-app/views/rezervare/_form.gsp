...
<div class="control-group fieldcontain ${hasErrors(bean: rezervareInstance, field: 'endDate', 'error')} ">
    ...
    <div class="controls">
        <bs:datePicker name="endDate" precision="day" value="${rezervareInstance?.endDate}" default="none"
                       noSelection="['': '']"/>
...
<div class="control-group fieldcontain ${hasErrors(bean: rezervareInstance, field: 'masa', 'error')} required">
    ...
    <div class="controls">
        <g:select id="masa" name="masa.id" from="${ro.isi.restaurant.Masa.list()}" optionKey="id" required=""
...
<div class="control-group fieldcontain ${hasErrors(bean: rezervareInstance, field: 'tableId', 'error')} required">
    <label for="tableId" class="control-label"><g:message code="rezervare.tableId.label" default="Table Id"/><span
            class="required-indicator">*</span></label>
