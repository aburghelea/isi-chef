		...
		<ul class="dropdown-menu">
			...
			<li class="dropdown-submenu">
				...
				<ul class="dropdown-menu dropdown-menu-dark">
					<li><a class="" title="${message(code: 'default.config.vertical.label', default:'Vertical')}" href="${request.forwardURI+'?layout=grid'}">
						<i class="icon-resize-vertical"></i>
						<g:message code="default.layout.grid.label" default="Grid 940px (Menu Top)"/>
					</a></li>
					<li><a class="" title="${message(code: 'default.config.horizontal.label', default:'Horizontal')}" href="${request.forwardURI+'?layout=fluid'}">
