...
class SecurityUiTagLib {
    ...
    def textFieldRow = { attrs ->
        ...
        <tr class="prop">
            ...
            <td valign="top" width="400px"  class="value ${hasErrors(bean: bean, field: name, 'errors')}">
    ...
    def submitButton = { attrs ->
        ...
        writer << ">${text}</a>\n"
        writer << "<input type='submit' style='visibility:hidden' value=' ' id='${elementId}_submit'  />\n"
    ...
    def deleteButtonForm = { attrs ->
        ...
        out << """
            ...
            <div id="deleteConfirmDialog" title="${message(code: 'user.delete.label', default: "Sigur?")}"></div>
            ...
            \$(document).ready(function() {
                ...
                \$("#deleteConfirmDialog").dialog({
                    ...
                    modal: true,
                    buttons: {
                        '${message(code: "default.button.delete.label", default: "Da")}': function() {
                            document.forms.deleteForm.submit();
                        },
                        '${message(code: "default.button.cancel.label", default: "Nu")}': function() {
                            \$(this).dialog('close');
                        }
                    }
                });
    ...
    def deleteButton = { attrs ->
        def classs = getRequiredAttribute(attrs, 'class', 'deleteButton')
        out << """<a id="deleteButton" class="${classs}">${message(code: 'default.button.delete.label')}</a>"""
    }
