...
<section id="edit-masa" class="first">

	<g:hasErrors bean="${masaInstance}">
	<div class="alert alert-error">
		<g:renderErrors bean="${masaInstance}" as="list" />
	</div>
	</g:hasErrors>

	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${masaInstance?.id}" />
		<g:hiddenField name="version" value="${masaInstance?.version}" />
		<fieldset class="form">
