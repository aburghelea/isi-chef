...
<section id="show-produs" class="first">
    ...
    <table class="table">
        ...
        <tr class="prop">
            <td valign="top" class="name"><g:message code="produs.preparationTime.label"
                                                     default="Preparation Time"/></td>
        ...
        <tr class="prop">
            <td valign="top" class="name"><g:message code="produs.stock.label"
                                                     default="Stock"/></td>

            <td valign="top" class="value">${fieldValue(bean: produsInstance, field: "stock")}</td>
