...
<s2ui:form width='350' height='220' elementId='forgotPasswordFormContainer'
	...
	<table>
		<tr>
			<td><label for="username"><g:message code='spring.security.ui.forgotPassword.username' default="Username"/></label></td>
			<td><g:textField name="username" size="25" /></td>
		</tr>
	</table>

	<s2ui:submitButton elementId='reset' form='forgotPasswordForm' messageCode='spring.security.ui.forgotPassword.submit' messageCodeDefault='Submit'/>
