<%@ page import="ro.isi.restaurant.Produs" %>
			...
			<div class="control-group fieldcontain ${hasErrors(bean: produsInstance, field: 'description', 'error')} ">
				<label for="description" class="control-label"><g:message code="produs.description.label" default="Description" /></label>
				<div class="controls">
			...
			<div class="control-group fieldcontain ${hasErrors(bean: produsInstance, field: 'preparationTime', 'error')} ">
				<label for="preparationTime" class="control-label"><g:message code="produs.preparationTime.label" default="Preparation Time" /></label>
				<div class="controls">
